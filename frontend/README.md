...
The two-week column currently re-scores the same candidate squads generated by the
six-week optimizer. This is a useful horizon-sensitivity view, but it is deliberately
labeled “same candidate set”; it does not claim to surface every independently optimized
two-week plan.
